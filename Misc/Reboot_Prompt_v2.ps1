...
function Call-MainForm_psf
{
 ...
 $labelITSystemsMaintenance.Text = 'TeamLogic IT'
...
If you do not wish to restart your computer at this time, please click the cancel button below. Your machine will restart if the timer runs out.'
 #
 # timerUpdate
 #
