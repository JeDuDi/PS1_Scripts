...
(Get-MsolUser -UserPrincipalName "name@domain.com").ImmutableID

#Log the ADSynced Account Immutable ID (to be assigned to the cloud-only account in another step):
(Get-MsolUser -UserPrincipalName "duplicatename@domain.com").ImmutableID
...
Set-MsolUser -UserPrincipalName "name@domain.com" -ImmutableID "xyzabc1234=="
